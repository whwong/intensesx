...
#define MSG_DESTROY         (MSG_WINDOW | 0x0003)
#define MSG_NCDESTROY       (MSG_WINDOW | 0x0004)
#define MSG_PAINT           (MSG_WINDOW | 0x0005)
#define MSG_NCPAINT         (MSG_WINDOW | 0x0006)
#define MSG_ENABLE          (MSG_WINDOW | 0x0007)
#define MSG_SETTEXT         (MSG_WINDOW | 0x0008)
#define MSG_GETTEXT         (MSG_WINDOW | 0x0009)
#define MSG_SETFONT         (MSG_WINDOW | 0x000A)
#define MSG_COMMAND         (MSG_WINDOW | 0x000B)
#define MSG_SETFOCUS        (MSG_WINDOW | 0x000C)
#define MSG_KILLFOCUS       (MSG_WINDOW | 0x000D)
#define MSG_WINDOWLAST      (MSG_WINDOW | 0x000D)
